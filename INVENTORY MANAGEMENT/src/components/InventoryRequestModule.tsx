...
// Item pricing per kg/liter (base prices)
const itemPricing = {
  'Basmati Rice': 80, // per kg
  'Toor Dal': 80, // per kg  
  'Refined Oil': 150, // per liter
  'Onions': 30, // per kg
  'Turmeric Powder': 150, // per kg
  'Wheat Flour': 30, // per kg
  'Sugar': 50, // per kg
  'Salt': 20, // per kg
  'Cumin Seeds': 400, // per kg
  'Coriander Seeds': 300 // per kg
};
            ...
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-4">
                  ...
                  <Button onClick={handleAddInventoryRequest}>
                    Add Request
                  </Button>
                </div>
              </div>
